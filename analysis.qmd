...
Toronto currently faces significant challenges related to income and housing, which often act as a motivators for crime. However, the city's efforts to provide affordable bike sharing has had a positive impact. Through these initiatives, Toronto is taking a proactive approach to improve the quality of life and as a side effect its reducing crime with the increased infrastructure. 
